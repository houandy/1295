...
#if 1//def __LINUX_MEDIA_NAS__ , for rtk_mi_init
#if 0
#define HDMI_HOTPLUG_DETECTION			_IOWR(HDMI_IOCTL_MAGIC,16, int)
#define HDMI_WAIT_HOTPLUG				_IOWR(HDMI_IOCTL_MAGIC,17, int)


#define HDMI_GET_EDID_SUPPORT_LIST		_IOWR(HDMI_IOCTL_MAGIC, 18, struct hdmi_support_list)
#define HDMI_SET_OUTPUT_FORMAT			_IOWR(HDMI_IOCTL_MAGIC, 19, struct hdmi_format_setting)
#define HDMI_GET_OUTPUT_FORMAT			_IOWR(HDMI_IOCTL_MAGIC, 20, struct hdmi_format_setting)
#define HDMI_SET_VO_INTERFACE_TYPE		_IOW(HDMI_IOCTL_MAGIC, 21, int)
#define HDMI_GET_CONFIG_TV_SYSTEM		_IOR(HDMI_IOCTL_MAGIC, 22, struct VIDEO_RPC_VOUT_CONFIG_TV_SYSTEM)
#endif
