...
fs-types-$(CONFIG_RTK_BOARD_FWDESC_LAYOUT) += rtkimg
...
initrd_compression_cmd = false
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_NONE),y)
initrd_compression_cmd = mv $(KDIR)/root.cpio $(KDIR)/root.cpio.bin
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_GZIP),y)
initrd_compression_cmd = gzip -n -9 -f $(KDIR)/root.cpio
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_BZIP2),y)
initrd_compression_cmd = bzip2 -9 -f $(KDIR)/root.cpio
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_LZMA),y)
initrd_compression_cmd = lzma e -d20 -lc1 -lp2 -pb2 -eos $(KDIR)/root.cpio $(KDIR)/root.cpio.lzma
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_LZO),y)
initrd_compression_cmd = lzop -9 -f $(KDIR)/root.cpio
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_LZ4),y)
initrd_compression_cmd = lz4 -l -9 -f $(KDIR)/root.cpio
endif
ifeq ($(CONFIG_TARGET_INITRAMFS_COMPRESSION_XZ),y)
initrd_compression_cmd = xz --check=crc32 --lzma2=dict=1MiB -f $(KDIR)/root.cpio
endif
...
$(KDIR)/root.%: kernel_prepare
	mkdir -p $(TARGET_DIR)/lib/modules/$(LINUX_UNAME_VERSION)
...
$(if $(Device/Default/Config),$(call Device/Default/Config))
$(if $(Device/$(1)/Config),$(call Device/$(1)/Config))
@@
